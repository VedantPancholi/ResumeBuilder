    ...
    <header className='w-full flex items-center justify-between px-4 py-3 lg:px-8 border-b border-gray-300 bg-bgPrimary z-50 gap-12 sticky top-0'>
      ...
      <div className='flex-1 border border-gray-300 px-4 py-1 rounded-md flex items-center justify between bg-gray-200'>
        <input
          ...
          className='flex-1 h-10 bg-transparent text-base font-semibold outline-non border-none'
        ></input>
      </div>
                  ...
                  {isMenu && (
                    ...
                    >
                      ...
                      <div className='w-full flex-col items-start flex gap-8 pt-6'>
                        <Link
                          className='text-txtLight hover:text-txtDark text-base whitespaze-nowrap'
                          to={'/profile'}
                        >
                          My Account
                        </Link>
                        ...
                        <div className='w-full px-2 py-2 border-t border-gray-300 flex items-center justify-between group' onClick={signOutUser}>
