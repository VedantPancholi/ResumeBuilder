...
import { BiFolder, BiFolderPlus, BiHeart } from "react-icons/bi"
...
const TemplateDesignPin = ({data, index}) => {
  ...
  return <motion.div key={data?._id} {...scaleInOut(index)}>
    <div className='w-full h-[500px] 2xl:h-[740px] rounded-md bg-gray-200 overflow-hidden relative'>
        ...
        <AnimatePresence>
            <motion.div {...FadeInOutWithOpacity} className='absolute inset-0 bg-[rgba(0,0,0,0.4)] flex flex-col items-center justify-start px-4 py-3 z-50 cursor-pointer'>
